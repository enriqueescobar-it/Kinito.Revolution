...
```{r project input, include=FALSE, echo=TRUE}
train <- read.csv("E:/Disk_X/Kinito.Revolution/Algorithm.t-SNE/Data/train.csv");
```

Data curation

```{r project curation, include=FALSE, echo=TRUE}
...
```{r project preparation, include=FALSE, echo=TRUE}
...
```{r project tSNE, include=FALSE, echo=TRUE}
...
```{r project plotting, include=FALSE, echo=TRUE}
